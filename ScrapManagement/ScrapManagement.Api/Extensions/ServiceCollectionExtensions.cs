...
using ScrapManagement.Api.Services;
using ScrapManagement.Application.DTOs.Settings;
using ScrapManagement.Application.Interfaces;
...
using ScrapManagement.Infrastructure.Identity.Services;
using System;
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        private static void RegisterSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                c.IncludeXmlComments(string.Format(@"{0}\ScrapManagement.Api.xml", System.AppDomain.CurrentDomain.BaseDirectory));
                c.SwaggerDoc("v1", new OpenApiInfo
                {
                    Version = "v1",
                    Title = "ScrapManagement",
